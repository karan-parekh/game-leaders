...
Multi-context repos use a root `CONTEXT-MAP.md` pointing to per-context `CONTEXT.md` files, with system-wide ADRs in `docs/adr/` and context-specific ADRs under `src/<context>/docs/adr/`.
